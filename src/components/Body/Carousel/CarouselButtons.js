...
export const PrevBtn = ({ enabled, onClick }) => (
	<button className="carousel__arrowBtn carousel__arrowBtn--prev" disable={!enabled} onClick={onClick}>
		<svg className="carousel__arrowBtn__svg" viewBox="138 -1.001 366.5 644">
			<path
				d="M428.36 12.5c16.67-16.67 43.76-16.67 60.42 0 16.67 16.67 16.67 
...
export const NextBtn = ({ enabled, onClick }) => (
	<button className="carousel__arrowBtn carousel__arrowBtn--next" disabled={!enabled} onClick={onClick}>
		<svg className="carousel__arrowBtn__svg" viewBox="0 0 238.003 238.003">
			<path
				d="M181.776 107.719L78.705 4.648c-6.198-6.198-16.273-6.198-22.47 
